...
#define         RL_VALOR4             (10)     //define el valor de la resistencia mde carga en kilo ohms
...
Serial.begin(9600);                                                                  //Inicializa Serial a 9600 baudios
 Serial.println("Iniciando ...");
  ...
  Ro = Calibracion(MQ4);                        //Calibrando el sensor. Por favor de asegurarse que el sensor se encuentre en una zona de aire limpio mientras se calibra
...
void loop()
{
  ...
  Serial.print("LP:");
   Serial.print(porcentaje_gas(lecturaMQ(MQ4)/Ro,GAS_LP) );
   Serial.print( "ppm" );
   Serial.print("    ");
   Serial.print("\n");
   delay(200);
...
{
  return ( ((float)RL_VALOR4*(1023-raw_adc)/raw_adc));
}
